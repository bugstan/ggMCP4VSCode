...
export class Config {
    ...
    public getPortScanConcurrency(): number {
        return this.extensionConfig.get<number>(
            'portScanConcurrency',
            Defaults.PortScanner.concurrency
        );
    }
    ...
    public isFileLoggingEnabled(): boolean {
        return this.extensionConfig.get<boolean>(
            'fileLoggingEnabled',
            Defaults.Logger.enableFileLogging
        );
    }
    ...
    public getAutoReloadModifiedFiles(): boolean {
        return this.extensionConfig.get<boolean>(
            'autoReloadModifiedFiles',
            Defaults.FileReloader.autoReloadModifiedFiles
        );
    }
    ...
    public getLargeFileThreshold(): number {
        return this.extensionConfig.get<number>(
            'largeFileThreshold',
            Defaults.FileReloader.largeFileThreshold
        );
    }
    ...
    public getPerformanceReportInterval(): number {
        return this.extensionConfig.get<number>(
            ...
            Defaults.Performance.reportInterval
        );
    }
    ...
    public getSlowOperationThreshold(): number {
        return this.extensionConfig.get<number>(
            ...
            Defaults.Performance.slowOperationThreshold
        );
    }
    ...
    public getShowFileChangeNotifications(): boolean {
        return this.extensionConfig.get<boolean>(
            'showFileChangeNotifications',
            Defaults.Notifications.showFileChangeNotifications
        );
    }
